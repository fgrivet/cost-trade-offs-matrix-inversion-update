...
```
F. Grivet and L. Travé-Massuyès, Cost trade-offs in matrix inversion updates for streaming outlier detection. Array (2026), doi: https://doi.org/10.1016/j.array.2026.100737.
```
